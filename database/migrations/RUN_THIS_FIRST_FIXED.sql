-- ================================================
-- NOTIFICATION SYSTEM DATABASE MIGRATION (FIXED)
-- ================================================
...
CREATE TABLE IF NOT EXISTS notification_preferences (
  ...
  reminder_days_before INT DEFAULT 3 COMMENT 'Days before due date to send reminder (1-7)',
...
-- ================================================
INSERT INTO notification_preferences (user_type, user_id)
SELECT 'admin', CAST(id AS CHAR)
FROM admins
WHERE NOT EXISTS (
  SELECT 1 FROM notification_preferences 
  WHERE user_type = 'admin' AND user_id = CAST(admins.id AS CHAR)
);
